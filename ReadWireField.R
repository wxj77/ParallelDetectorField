...
SurfaceFieldTable= read.table(paste(workdir,"/EFieldOnSurfacesDetail1.txt",sep=""),skip=9)
...
plot(SurfaceFieldTable$V1,SurfaceFieldTable$V2)
plot(SurfaceFieldTable$V1,SurfaceFieldTable$V7, xlab ="x", ylab = "E(V/m)", main="Surface Field on the gate wires")
